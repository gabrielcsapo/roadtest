...
function l({ entry: e }) {
  let [t, n] = (0, r.useState)(!1),
    l = a(e.status),
    u = o(e.method),
    d = !!(e.requestBody || e.responseBody);
  return (0, i.jsxs)(`div`, {
    style: {
      borderRadius: 6,
      background: `#1a1a24`,
          ...
          children: [
            e.requestBody &&
              (0, i.jsxs)(`div`, {
                style: {
                  padding: `8px 12px`,
                  borderBottom: e.responseBody ? `1px solid #1e1e2e` : `none`,
                },
                children: [
                  (0, i.jsx)(`div`, {
                    style: {
                  ...
                  (0, i.jsx)(`div`, {
                    ...
                    children: (0, i.jsx)(c, { raw: e.requestBody }),
                  }),
                ],
              }),
            e.responseBody &&
              (0, i.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, i.jsx)(`div`, {
                    ...
                    children: (0, i.jsx)(c, { raw: e.responseBody }),
                  }),
                ],
              }),
          ],
  ...
  if (t.length === 0)
    return (0, i.jsxs)(`div`, {
      ...
      children: [
        ...
        (0, i.jsx)(`div`, { style: { fontSize: 13 }, children: `No network requests captured` }),
      ],
    });
  let n = t.filter((e) => e.mocked).length;
  return (0, i.jsxs)(`div`, {
      ...
      (0, i.jsxs)(`div`, {
        ...
        children: [
          (0, i.jsxs)(`span`, {
            ...
            children: [t.length, ` request`, t.length === 1 ? `` : `s`],
          }),
          n > 0 &&
            (0, i.jsxs)(`span`, {
          ...
          n < t.length &&
            (0, i.jsxs)(`span`, {
              ...
              children: [t.length - n, ` passthrough`],
            }),
        ],
      }),
      t.map((e, t) => (0, i.jsx)(l, { entry: e }, t)),
    ],
  });
}
export { u as NetworkTab };
//# sourceMappingURL=NetworkTab-NB4GXuqP.js.map
