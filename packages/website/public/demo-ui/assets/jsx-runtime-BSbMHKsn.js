...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
        ...
        if (
          ...
          for (var h in ((r = {}), t)) h !== `key` && (r[h] = t[h]);
        else r = t;
        return (
          f && l(r, typeof e == `function` ? e.displayName || e.name || `Unknown` : e),
          d(e, f, r, o(), s, u)
        );
      }
      function p(e) {
      ...
      var h = t(),
        ...
        A = h.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,
        j = Object.prototype.hasOwnProperty,
        M = Array.isArray,
        N = console.createTask
          ? console.createTask
          : function () {
              return null;
            };
      ...
      var P,
        F = {},
        I = h.react_stack_bottom_frame.bind(h, s)(),
        L = N(a(s)),
        R = {};
      ((e.Fragment = v),
...
export { r as t };
//# sourceMappingURL=jsx-runtime-BSbMHKsn.js.map
