import {
  ...
  t as te,
  u as ne,
} from "./isCommonAssetRequest-Cr39sXTT.js";
var re = class {
    #e;
    #t;
    constructor() {
  ...
  u = Symbol(`kDefaultPrevented`),
  d = Symbol(`kPropagationStopped`),
  f = Symbol(`kImmediatePropagationStopped`),
  p = class extends MessageEvent {
    [u];
    [d];
    [f];
    constructor(...e) {
      (super(e[0], e[1]), (this[u] = !1));
    }
    get defaultPrevented() {
      return this[u];
    }
    preventDefault() {
      (super.preventDefault(), (this[u] = !0));
    }
    stopImmediatePropagation() {
      (super.stopImmediatePropagation(), (this[f] = !0));
    }
  },
  ...
  m = class {
    ...
    emit(e) {
      ...
      for (let t of this.#i(e.type)) {
        if (n.event[d] != null && n.event[d] !== this) return (n.revoke(), !1);
        if (n.event[f]) break;
        this.#r(n.event, t);
      }
      return (n.revoke(), t);
    ...
    async emitAsPromise(e) {
      ...
      for (let r of this.#i(e.type)) {
        if (n.event[d] != null && n.event[d] !== this) return (n.revoke(), []);
        if (n.event[f]) break;
    ...
    *emitAsGenerator(e) {
      ...
      for (let n of this.#i(e.type)) {
        if (t.event[d] != null && t.event[d] !== this) {
          t.revoke();
          return;
        }
        if (t.event[f]) break;
    ...
    #n(e) {
      ...
      return (
        (e.stopPropagation = new Proxy(e.stopPropagation, {
          apply: (t, n, r) => ((e[d] = this), Reflect.apply(t, n, r)),
        })),
        {
          event: e,
          revoke() {
...
var oe = class {
    ...
    use(e) {
      ...
      for (let n = e.length - 1; n >= 0; n--) {
        let r = e[n];
        t[r.kind] = t[r.kind] ? [r, ...t[r.kind]] : [r];
      }
    ...
    reset(e) {
      ...
      let i = ae(e);
      this.setState({ initialHandlers: i, handlers: { ...i } });
    }
    #e(e) {
...
var de = async ({ request: e, requestId: t, handlers: n, resolutionContext: r }) => {
  let i = null,
    a = null;
  for (let o of n)
    if (
...
function me(e) {
  let t = 0,
    r = new m(),
    i = (e) => (e instanceof oe ? e : new se(e || [])),
    a = { ...e },
    o = i(a.handlers),
    s;
  return {
    ...
    enable() {
      return (
        n(t === 0, `Failed to call "enable" on the network: already enabled`),
    ...
    disable() {
      return (
        n(t === 1, `Failed to call "disable" on the network: already disabled`),
        s.abort(),
        (t = 0),
...
var he = class extends p {
  ...
  _e = class {
    constructor(e, t) {
      ((this.protocol = e), (this.data = t), (this.events = new m()));
    }
    events;
  };
function ve(e) {
...
async function g(e, t) {
  let i = async (t) => {
      ...
      switch (t) {
        case `warn`:
          return r.warn(`Warning: %s`, n);
        case `error`:
          return r.error(`Error: %s`, n);
      }
    },
    o = async (e) => {
      if (
  ...
  if (typeof t == `function`)
    return t({ frame: e, defaults: { warn: i.bind(null, `warn`), error: i.bind(null, `error`) } });
  if (!(e instanceof v && te(e.data.request))) return o(t);
}
var _ = class extends p {
  ...
  v = class extends _e {
    constructor(e) {
      let n = e.id || t();
      super(`http`, { id: n, request: e.request });
    }
    getHandlers(e) {
...
Read more: https://mswjs.io/docs/http/intercepting-requests`;
    ...
    async resolve(e, t, n) {
      let { id: i, request: a } = this.data,
        o = n?.quiet ? null : a.clone();
      if ((this.events.emit(new _(`request:start`, { requestId: i, request: a })), ve(a)))
        return (
          this.events.emit(new _(`request:end`, { requestId: i, request: a })),
          this.passthrough(),
          null
        );
      let [s, c] = await ue(() =>
      ...
      if (s != null)
        return (
          this.events.emit(new Se(`unhandledException`, { error: s, requestId: i, request: a })) ||
            (console.error(s),
            r.error(
      ...
      if (c == null)
        return (
          this.events.emit(new _(`request:unhandled`, { requestId: i, request: a })),
          await g(this, t).then(
            () => this.passthrough(),
            (e) => this.errorWith(e),
          ),
      ...
      return (
        this.events.emit(new _(`request:match`, { requestId: i, request: a })),
        l == null || ye(l)
          ? (this.events.emit(new _(`request:end`, { requestId: i, request: a })),
            this.passthrough(),
            null)
          : (await fe(a, l),
            this.respondWith(l.clone()),
            this.events.emit(new _(`request:end`, { requestId: i, request: a })),
            n?.quiet || ee.log({ request: o, response: l, parsedResult: te }),
            !0)
      );
    }
  },
  ...
  Te = class extends _e {
    ...
    async resolve(e, t, n) {
      let { connection: i } = this.data;
      if (
        (this.events.emit(new Ce(`connection`, { url: i.client.url, protocols: i.info.protocols })),
        e.length === 0)
      )
        return (
          await g(this, t).then(
      ...
      let a = !1;
      for (let t of e) {
        let e = await t.run(i, { baseUrl: n?.baseUrl?.toString(), [o]: !1 });
        if (!e) continue;
        a = !0;
        let s = n?.quiet ? void 0 : t.log(i);
        try {
          t[l](e) || s?.();
        } catch (e) {
          throw (
...
Read more: https://mswjs.io/docs/websocket`;
  ...
  Ee = class extends ge {
    ...
    constructor(e) {
      (super(),
        (this.#e = new ne({ name: `interceptor-source`, interceptors: e.interceptors })),
        (this.#t = new Map()));
    }
    enable() {
      (this.#e.apply(),
  ...
  De = class extends v {
    ...
    errorWith(e) {
      ...
      throw (e instanceof a && this.#e.errorWith(e), e);
    }
  },
  Oe = class extends Te {
    constructor(e) {
    ...
    if (i != null) {
      if (typeof i == `function`) {
        ...
        return (
          ...
          i(e, { warning: r.warn, error: r.error })
        );
      }
      return g(t, i);
    }
...
var Le = Object.defineProperty,
  ...
  x = {};
Re(x, { blue: () => Be, gray: () => Ve, green: () => Ue, red: () => He, yellow: () => ze });
function ze(e) {
...
function ot(e) {
  if (typeof e == `string`) return ot(new URL(e, typeof location < `u` ? location.href : void 0));
  if (
    (e.protocol === `http:`
      ? (e.protocol = `ws:`)
...
var A = Symbol(`kCancelable`),
  j = Symbol(`kDefaultPrevented`),
  M = class extends MessageEvent {
    constructor(e, t) {
      (super(e, t), (this[A] = !!t.cancelable), (this[j] = !1));
    }
    get cancelable() {
      return this[A];
    }
    ...
    preventDefault() {
      this.cancelable && !this[j] && (this[j] = !0);
    }
  },
  ...
  lt = class {
    constructor(e, t) {
      ((this.socket = e),
        ...
        this.transport.addEventListener(`outgoing`, (e) => {
          let t = k(
            this.socket,
            new M(`message`, { data: e.data, origin: e.origin, cancelable: !0 }),
          );
          (this[P].dispatchEvent(t), t.defaultPrevented && e.preventDefault());
        }),
        this.transport.addEventListener(`close`, (e) => {
          this[P].dispatchEvent(k(this.socket, new N(`close`, e)));
        }));
    }
    addEventListener(e, t, n) {
      ...
      this[P].addEventListener(e, Reflect.get(t, F), n);
    }
    removeEventListener(e, t, n) {
      this[P].removeEventListener(e, Reflect.get(t, F), n);
    }
    send(e) {
  ...
  ut = `InvalidAccessError: close code out of user configurable range`,
  I = Symbol(`kPassthroughPromise`),
  dt = Symbol(`kOnSend`),
  L = Symbol(`kClose`),
  ft = class extends EventTarget {
    static {
      this.CONNECTING = 0;
    }
    static {
      ...
      (super(),
        ...
        queueMicrotask(async () => {
          (await this[I]) ||
            ...
            this.readyState === this.CONNECTING &&
              ((this.readyState = this.OPEN), this.dispatchEvent(k(this, new Event(`open`)))));
        }));
    }
    set onopen(e) {
    ...
    send(e) {
      ...
      this.readyState === this.CLOSING ||
        ...
        ((this.bufferedAmount += pt(e)),
        queueMicrotask(() => {
          ((this.bufferedAmount = 0), this[dt]?.(e));
        }));
    }
    close(e = 1e3, t) {
      (b(e, ut), b(e === 1e3 || (e >= 3e3 && e <= 4999), ut), this[L](e, t));
    }
    [L](e = 1e3, t, n = !0) {
      this.readyState === this.CLOSING ||
        this.readyState === this.CLOSED ||
        ...
        queueMicrotask(() => {
          ((this.readyState = this.CLOSED),
            this.dispatchEvent(k(this, new N(`close`, { code: e, reason: t, wasClean: n }))),
            (this._onopen = null),
            (this._onmessage = null),
            (this._onerror = null),
            (this._onclose = null));
  ...
  mt = class {
    constructor(e, t, n) {
      ((this.client = e),
        ...
        (this[R] = new EventTarget()),
        (this.mockCloseController = new AbortController()),
        (this.realCloseController = new AbortController()),
        this.transport.addEventListener(`outgoing`, (e) => {
          this.realWebSocket !== void 0 &&
            queueMicrotask(() => {
              e.defaultPrevented || this[B](e.data);
            });
        }),
    ...
    connect() {
      ...
      ((e.binaryType = this.client.binaryType),
        e.addEventListener(
          `open`,
          (e) => {
            this[R].dispatchEvent(k(this.realWebSocket, new Event(`open`, e)));
          },
          { once: !0 },
        ),
        e.addEventListener(`message`, (e) => {
          this.transport.dispatchEvent(
            k(this.realWebSocket, new MessageEvent(`incoming`, { data: e.data, origin: e.origin })),
          );
        }),
        ...
        e.addEventListener(`error`, () => {
          let t = k(e, new Event(`error`, { cancelable: !0 }));
          (this[R].dispatchEvent(t),
            t.defaultPrevented || this.client.dispatchEvent(k(this.client, new Event(`error`))));
        }),
    ...
    addEventListener(e, t, n) {
      if (!Reflect.has(t, z)) {
        ...
        Object.defineProperty(t, z, { value: e, enumerable: !1 });
      }
      this[R].addEventListener(e, Reflect.get(t, z), n);
    }
    removeEventListener(e, t, n) {
      this[R].removeEventListener(e, Reflect.get(t, z), n);
    }
    send(e) {
      this[B](e);
    }
        ...
        !(e.readyState === WebSocket.CLOSING || e.readyState === WebSocket.CLOSED) &&
          ...
          queueMicrotask(() => {
            this[R].dispatchEvent(
              k(this.realWebSocket, new ct(`close`, { code: 1e3, cancelable: !0 })),
            );
          })));
    }
    handleIncomingMessage(e) {
      let t = k(e.target, new M(`message`, { data: e.data, origin: e.origin, cancelable: !0 }));
      (this[R].dispatchEvent(t),
        t.defaultPrevented ||
          this.client.dispatchEvent(
            k(this.client, new MessageEvent(`message`, { data: e.data, origin: e.origin })),
          ));
    }
    handleMockClose(e) {
    ...
    handleRealClose(e) {
      ...
      let t = k(
        this.realWebSocket,
        new ct(`close`, { code: e.code, reason: e.reason, wasClean: e.wasClean, cancelable: !0 }),
      );
      (this[R].dispatchEvent(t), t.defaultPrevented || this.client[L](e.code, e.reason));
    }
  },
    ...
    constructor(e) {
      (super(),
        ...
        this.socket.addEventListener(`close`, (e) => {
          this.dispatchEvent(k(this.socket, new N(`close`, e)));
        }),
        (this.socket[dt] = (e) => {
          this.dispatchEvent(
            k(this.socket, new M(`outgoing`, { data: e, origin: this.socket.url, cancelable: !0 })),
          );
        }));
    }
    addEventListener(e, t, n) {
      ...
      queueMicrotask(() => {
        ...
        let t = () => {
          this.socket.dispatchEvent(
            k(this.socket, new MessageEvent(`message`, { data: e, origin: this.socket.url })),
          );
        };
            ...
            return (
              queueMicrotask(async () => {
                try {
                  ...
                  (await E(this.emitter, `connection`, {
                    client: new lt(o, s),
                    server: e,
                    info: { protocols: i },
                  }),
                    t
                      ...
                      : (o[I].resolve(!0),
                        ...
                        e.addEventListener(`open`, () => {
                          (o.dispatchEvent(k(o, new Event(`open`))),
...
var kt = async (e, t = {}, n) => {
    let i = Dt(e),
      a = await navigator.serviceWorker
        .getRegistrations()
        .then((e) => e.filter((e) => Ot(e, i, n)));
    !navigator.serviceWorker.controller && a.length > 0 && location.reload();
    let [o] = a;
    if (o) return (o.update(), [Ot(o, i, n), o]);
    ...
    if (s) {
      if (s.message.includes(`(404)`)) {
        ...
        throw Error(
          r.formatMessage(`Failed to register a Service Worker for scope ('${e.href}') with script ('${i}'): Service Worker script does not exist at the given path.
        ...
        Pt &&
          navigator.serviceWorker.addEventListener(`message`, async (e) => {
            ...
            (e.source != null && e.source !== t) ||
              (e.data && le(e.data) && `type` in e.data && this.emit(new Ft(e)));
          }));
    }
    postMessage(e) {
      (b(
...
function zt(e) {
  location.href.startsWith(e.scope) ||
    r.warn(`Cannot intercept requests on this page because it's outside of the worker's scope ("${e.scope}"). If you wish to mock API requests on this page, you must resolve this scope issue.
    ...
    async #l() {
      ...
      return (
        ...
        this.#t.once(`INTEGRITY_CHECK_RESPONSE`, (t) => {
          let { checksum: n, packageVersion: i } = t.data;
          (n !== `4db4a41e972cec1b64cc569c66952d82` &&
            r.warn(`The currently registered Service Worker has been generated by a different version of MSW (${i}) and may not be fully compatible with the installed version.
...
You can also automate this process and make the worker script update automatically upon the library installations. Read more: https://mswjs.io/docs/cli/init.`),
    ...
    async #u() {
      ...
      (console.groupCollapsed(
        `%c${r.formatMessage(`Mocking enabled.`)}`,
    ...
    #d() {
      console.log(`%c${r.formatMessage(`Mocking disabled.`)}`, `color:orangered;font-weight:bold;`);
    }
  },
  Vt = class extends v {
    #e;
...
async function Jt(e) {
  ...
  if (i.error) {
    ...
    if (e.emitter.listenerCount(`unhandledException`) > 0) {
      ...
      if (
        (await E(e.emitter, `unhandledException`, {
          error: i.error,
          request: e.request,
          requestId: e.requestId,
          controller: n,
...
var Cn = class e extends it {
  ...
  wn = class extends Ee {
    ...
    #e() {
      (console.groupCollapsed(
        `%c${r.formatMessage(`Mocking enabled (fallback mode).`)}`,
        `color:orangered;font-weight:bold;`,
      ),
        console.log(
          `%cDocumentation: %chttps://mswjs.io/docs`,
...
function En(...e) {
  b(!Ie(), r.formatMessage("Failed to execute `setupWorker` in a non-browser environment"));
  ...
  return {
    async start(e) {
      ...
      if (
        (t.configure({
          sources: [n, new Ee({ interceptors: [new gt()] })],
...
//# sourceMappingURL=browser-C9yF4_qq.js.map
