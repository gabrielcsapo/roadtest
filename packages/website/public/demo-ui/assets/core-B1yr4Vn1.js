...
async function m(e) {
  ...
  return {
    status: r,
    statusText: t.statusText || p[r] || `OK`,
  ...
  S = (e, t, n, r) => {
    if ((t && typeof t == `object`) || typeof t == `function`)
      for (let i of v(t))
        !b.call(e, i) &&
          i !== n &&
          g(e, i, { get: () => t[i], enumerable: !(r = _(t, i)) || r.enumerable });
    return e;
  },
  C = ((e, t, n) => (
    (n = e == null ? {} : h(y(e))),
    S(t || !e || !e.__esModule ? g(n, `default`, { value: e, enumerable: !0 }) : n, e)
  ))(
    x({
...
function k(e) {
  ...
  switch (e.credentials) {
    case `same-origin`: {
      let t = new URL(e.url);
      return location.origin === t.origin ? O() : {};
    }
    case `include`:
      return O();
    default:
...
function A(e) {
  let t = e.headers.get(`cookie`),
    n = t ? D(t) : {},
    r = k(e);
  for (let t in r) e.headers.append(`cookie`, E(t, r[t]));
  let i = a.getCookies(e.url),
    o = Object.fromEntries(i.map((e) => [e.key, e.value]));
  ...
  M = class extends o {
    ...
    async parse(t) {
      ...
      if (typeof this.info.path == `function`) {
        let e = await this.info.path({ request: t.request, cookies: r });
        return { match: typeof e == `boolean` ? { matches: e, params: {} } : e, cookies: r };
      }
      return {
        match: this.info.path
          ? e(n, this.info.path, t.resolutionContext?.baseUrl)
          : { matches: !1, params: {} },
        cookies: r,
      };
    }
    ...
    matchMethod(e) {
      return this.info.method instanceof RegExp ? this.info.method.test(e) : l(this.info.method, e);
    }
    extendResolverArgs(e) {
      return { params: e.parsedResult.match?.params || {}, cookies: e.parsedResult.cookies };
    }
    async log(e) {
      let t = s(e.request.url),
        n = await f(e.request),
        i = await m(e.response),
        a = u(i.status);
      (console.groupCollapsed(
        r.formatMessage(`${d()} ${e.request.method} ${t} (%c${i.status} ${i.statusText}%c)`),
        `color:${a}`,
        `color:inherit`,
      ),
...
c();
export { M as n, j as r, P as t };
//# sourceMappingURL=core-B1yr4Vn1.js.map
