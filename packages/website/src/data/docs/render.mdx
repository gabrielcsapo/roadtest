...
If you've set up `.roadtest/preview.tsx`, any providers (themes, router, context) defined there wrap every `render()` call automatically — no extra setup needed per test.
