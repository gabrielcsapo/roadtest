...
function SearchHarness({
  ...
  return (
    <div>
      ...
      <input data-testid="input" value={query} onChange={(e) => setQuery(e.target.value)} />
      <button data-testid="clear" onClick={clearSearch}>
        clear
      </button>
      <button data-testid="set-hello" onClick={() => setQuery("hello")}>
        set hello
      </button>
      <button data-testid="set-world" onClick={() => setQuery("world")}>
        set world
      </button>
      <button data-testid="set-empty" onClick={() => setQuery("")}>
        set empty
      </button>
      <button data-testid="set-spaces" onClick={() => setQuery("   ")}>
        set spaces
      </button>
    </div>
  );
