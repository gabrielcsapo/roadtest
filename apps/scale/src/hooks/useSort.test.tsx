...
function SortHarness({ initialField = "", initialDir = "asc" as "asc" | "desc" }) {
  const { sort, setSort, toggleSort, resetSort, isSortedBy, getSortDirection } = useSort(
    initialField,
    initialDir,
  );
  return (
    <div>
      ...
      <button data-testid="sort-name-asc" onClick={() => setSort("name", "asc")}>
        sort name asc
      </button>
      <button data-testid="sort-name-desc" onClick={() => setSort("name", "desc")}>
        sort name desc
      </button>
      <button data-testid="sort-date-asc" onClick={() => setSort("date", "asc")}>
        sort date asc
      </button>
      <button data-testid="sort-date-desc" onClick={() => setSort("date", "desc")}>
        sort date desc
      </button>
      <button data-testid="sort-status" onClick={() => setSort("status")}>
        sort status default
      </button>
      <button data-testid="sort-risk" onClick={() => setSort("risk")}>
        sort risk
      </button>

      <button data-testid="toggle-name" onClick={() => toggleSort("name")}>
        toggle name
      </button>
      <button data-testid="toggle-date" onClick={() => toggleSort("date")}>
        toggle date
      </button>
      <button data-testid="toggle-status" onClick={() => toggleSort("status")}>
        toggle status
      </button>
      <button data-testid="toggle-risk" onClick={() => toggleSort("risk")}>
        toggle risk
      </button>

      <button data-testid="reset" onClick={resetSort}>
        reset
      </button>
    </div>
  );
