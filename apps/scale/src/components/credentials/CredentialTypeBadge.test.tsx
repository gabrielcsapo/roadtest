...
describe("CredentialTypeBadge", () => {
  ...
  it("snapshot: api-key md with label", async () => {
    const { container } = await render(
      <CredentialTypeBadge type="api-key" size="md" showLabel={true} />,
    );
  ...
  it("snapshot: certificate lg with label", async () => {
    const { container } = await render(
      <CredentialTypeBadge type="certificate" size="lg" showLabel={true} />,
    );
  ...
  it("snapshot: password sm no label", async () => {
    const { container } = await render(
      <CredentialTypeBadge type="password" size="sm" showLabel={false} />,
    );
