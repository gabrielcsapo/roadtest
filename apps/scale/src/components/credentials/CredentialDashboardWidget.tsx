    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '20px' }}>
        <div
          ...
          style={{ padding: '14px', borderRadius: '8px', background: '#f8fafc', border: '1px solid #e5e7eb', textAlign: 'center' }}
        >
          <div data-testid="stat-total-count" style={{ fontSize: '26px', fontWeight: 700, color: '#111827' }}>
            {total}
          </div>
        ...
        >
          <div
            ...
            style={{ fontSize: '26px', fontWeight: 700, color: expiringSoonCount > 0 ? '#b45309' : '#111827' }}
          >
            {expiringSoonCount}
          </div>
        ...
        >
          <div
            ...
            style={{ fontSize: '26px', fontWeight: 700, color: expiredCount > 0 ? '#dc2626' : '#111827' }}
          >
            {expiredCount}
          </div>
      ...
      {/* By type breakdown */}
      <div data-testid="type-breakdown" style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
        ...
        {Object.entries(byType).map(([type, count]) => (
          ...
          >
            <span style={{ color: '#374151' }}>{type === 'api-key' ? 'API Keys' : type === 'oauth-token' ? 'OAuth Tokens' : type.charAt(0).toUpperCase() + type.slice(1) + 's'}</span>
