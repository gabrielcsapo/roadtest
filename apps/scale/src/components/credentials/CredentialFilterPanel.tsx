            ...
            return (
              ...
              >
                ...
                {counts?.[type] !== undefined && (
                  <span data-testid={`type-count-${type}`} style={{ marginLeft: 'auto', fontSize: '12px', color: '#9ca3af' }}>
                    {counts[type]}
                  </span>
                )}
              </label>
            ...
            return (
              ...
              >
                ...
                {counts?.[status] !== undefined && (
                  <span data-testid={`status-count-${status}`} style={{ marginLeft: 'auto', fontSize: '12px', color: '#9ca3af' }}>
                    {counts[status]}
                  </span>
                )}
              </label>
              ...
              return (
                ...
                >
                  ...
                  {counts?.[service] !== undefined && (
                    <span data-testid={`service-count-${svcId}`} style={{ marginLeft: 'auto', fontSize: '12px', color: '#9ca3af' }}>
                      {counts[service]}
                    </span>
                  )}
                </label>
