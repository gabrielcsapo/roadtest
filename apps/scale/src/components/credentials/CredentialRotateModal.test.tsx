...
describe('CredentialRotateModal', () => {
  ...
  it('does not render when open=false', async () => {
    const { queryByTestId } = await render(
      <CredentialRotateModal credential={mockCred} open={false} onClose={() => {}} onConfirm={() => {}} />
    )
  ...
  it('renders when open=true', async () => {
    const { getByTestId } = await render(
      <CredentialRotateModal credential={mockCred} open={true} onClose={() => {}} onConfirm={() => {}} />
    )
  ...
  it('calls onClose when cancel button clicked', async () => {
    let closed = false
    const { getByTestId } = await render(
      <CredentialRotateModal credential={mockCred} open={true} onClose={() => { closed = true }} onConfirm={() => {}} />
    )
  ...
  it('does not call onConfirm when value is empty', async () => {
    let confirmed = false
    const { getByTestId } = await render(
      <CredentialRotateModal credential={mockCred} open={true} onClose={() => {}} onConfirm={() => { confirmed = true }} />
    )
    await fireEvent.click(getByTestId('confirm-btn'))
  ...
  it('calls onConfirm with value when valid', async () => {
    let confirmedValue = ''
    const { getByTestId } = await render(
      <CredentialRotateModal credential={mockCred} open={true} onClose={() => {}} onConfirm={(v) => { confirmedValue = v }} />
    )
    await fireEvent.change(getByTestId('credential-value-input'), { target: { value: 'new-key-value' } })
    await fireEvent.click(getByTestId('confirm-btn'))
  ...
  for (const type of types) {
    it(`renders correctly for type=${type}`, async () => {
      ...
      const { getByTestId } = await render(
        <CredentialRotateModal credential={cred} open={true} onClose={() => {}} onConfirm={() => {}} />
      )
      expect(getByTestId('rotate-modal')).toBeDefined()
    })
    ...
    it(`calls onConfirm for type=${type} with filled value`, async () => {
      ...
      let confirmedValue = ''
      const { getByTestId } = await render(
        <CredentialRotateModal credential={cred} open={true} onClose={() => {}} onConfirm={(v) => { confirmedValue = v }} />
      )
      await fireEvent.change(getByTestId('credential-value-input'), { target: { value: 'test-value' } })
      await fireEvent.click(getByTestId('confirm-btn'))
  ...
  it('shows loading state when loading=true', async () => {
    const { getByTestId } = await render(
      <CredentialRotateModal credential={mockCred} open={true} onClose={() => {}} onConfirm={() => {}} loading={true} />
    )
    expect(getByTestId('rotate-modal')).toBeDefined()
  })
  ...
  it('buttons are not disabled when not loading', async () => {
    const { getByTestId } = await render(
      <CredentialRotateModal credential={mockCred} open={true} onClose={() => {}} onConfirm={() => {}} loading={false} />
    )
  ...
  for (const type of types) {
    ...
    it(`cancel works for type=${type}`, async () => {
      ...
      let closed = false
      const { getByTestId } = await render(
        <CredentialRotateModal credential={cred} open={true} onClose={() => { closed = true }} onConfirm={() => {}} />
      )
      await fireEvent.click(getByTestId('cancel-btn'))
      expect(closed).toBe(true)
    })
    ...
    it(`submit with value works for type=${type}`, async () => {
      ...
      await fireEvent.change(getByTestId('credential-value-input'), { target: { value: 'my-new-secret' } })
      await fireEvent.click(getByTestId('confirm-btn'))
    ...
    it(`loading disables confirm for type=${type}`, async () => {
      const cred = { ...mockCred, type }
      const { getByTestId } = await render(
        <CredentialRotateModal credential={cred} open={true} onClose={() => {}} onConfirm={() => {}} loading={true} />
      )
      expect((getByTestId('confirm-btn') as HTMLButtonElement).disabled).toBe(true)
    })
  }
  ...
  for (const type of types) {
    ...
    it(`confirming with value calls onConfirm for type=${type}`, async () => {
      let confirmed = false
      const { getByTestId } = await render(
        <CredentialRotateModal credential={cred} open={true} onClose={() => {}} onConfirm={() => { confirmed = true }} />
      )
