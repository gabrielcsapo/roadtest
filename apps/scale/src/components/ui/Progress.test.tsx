...
describe('Progress', () => {
  ...
  const stepValues = [0, 4, 8, 12, 16, 20, 24, 28, 32, 36, 40, 44, 48, 52, 56, 60, 64, 68, 72, 76, 80, 84, 88, 92, 96, 100]
  ...
  const labels = ['Security Score', 'Compliance Rate', 'Policy Adoption', 'Risk Coverage', 'Audit Progress', 'Control Implementation']
  ...
  const colors = ['#ef4444', '#f97316', '#fbbf24', '#4ade80', '#60a5fa', '#a78bfa', '#f472b6', '#34d399', '#fb7185', '#38bdf8', '#818cf8', '#c084fc', '#94a3b8', '#6366f1', '#10b981']
