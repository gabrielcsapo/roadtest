...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    ...
    >
      {loading && (
        <span data-testid="button-spinner" aria-hidden="true" style={{ display: 'inline-block', width: '12px', height: '12px', border: '2px solid currentColor', borderTopColor: 'transparent', borderRadius: '50%', animation: 'spin 0.6s linear infinite' }} />
      )}
