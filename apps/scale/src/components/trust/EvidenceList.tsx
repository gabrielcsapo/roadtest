...
export function EvidenceList({
  ...
  return (
    <div
      data-testid="evidence-list-container"
      data-count={evidence.length}
      data-readonly={readonly}
    >
      <div
        data-testid="evidence-list-header"
        style={{
          display: "flex",
      ...
      >
        ...
        {!readonly && onUpload && (
          <Button data-testid="upload-button" variant="secondary" size="sm" onClick={onUpload}>
            Upload
          </Button>
        )}
      </div>
        ...
        <EmptyState
          ...
          description={
            readonly
              ...
              : "Upload evidence files to support this control."
          }
        />
      ) : (
