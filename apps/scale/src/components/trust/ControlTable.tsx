...
export function ControlTable({
  ...
  if (loading) {
    return (
      <div
        data-testid="control-table-loading"
  ...
  return (
    <div data-testid="control-table-container">
      <div
        data-testid="framework-filter-tabs"
      ...
      {filteredControls.length === 0 ? (
        <EmptyState
          data-testid="control-table-empty"
          ...
          <tbody data-testid="control-table-body">
            {filteredControls.map((control) => (
              <tr key={control.id} data-testid={`control-row-${control.id}`}>
                ...
                <td data-testid={`control-evidence-${control.id}`}>
                  {control.evidence.length} files
                </td>
                <td data-testid={`control-owner-${control.id}`}>
                  {control.owner?.name ?? "Unassigned"}
                </td>
      ...
      <div
        data-testid="control-table-footer"
