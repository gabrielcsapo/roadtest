...
export function ControlCard({ control, onClick, onEdit, onAddEvidence }: ControlCardProps) {
  ...
  return (
    ...
    >
      <div
        data-testid="control-card-header"
        style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}
      >
        <div style={{ flex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
            <PolicyFrameworkBadge framework={control.framework} size="sm" />
            <Badge data-testid="control-status-badge" color={statusColors[control.status]}>
      ...
      >
        <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
          <span data-testid="evidence-count" style={{ fontSize: "0.75rem", color: "#6b7280" }}>
