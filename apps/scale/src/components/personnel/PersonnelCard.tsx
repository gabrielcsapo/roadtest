  ...
  return (
    ...
    >
      <div data-testid="personnel-avatar">
        <Avatar name={person.name} src={person.avatarUrl} size={compact ? 32 : 48} />
      </div>

      <div data-testid="personnel-info" style={{ flex: 1, minWidth: 0 }}>
        <div
        ...
        {!compact && (
          <div style={{ display: "flex", gap: "8px", flexWrap: "wrap", marginTop: "10px" }}>
            <PersonnelStatusBadge status={person.status} size="sm" showIcon={true} />
      ...
      {(onEdit || onOffboard) && (
        ...
        >
          {onEdit && (
            <Button data-testid="edit-button" variant="ghost" size="sm" onClick={handleEdit}>
              Edit
            </Button>
          )}
      ...
      {person.manager && !compact && (
        <div data-testid="personnel-manager" style={{ fontSize: "12px", color: "#9ca3af" }}>
          Manager: {person.manager.name}
        </div>
      )}

      {!compact && (
        <div data-testid="personnel-start-date" style={{ fontSize: "12px", color: "#9ca3af" }}>
