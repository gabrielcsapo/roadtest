    ...
    <div data-testid="offboarding-flow" style={{ padding: '24px', maxWidth: '640px' }}>
      ...
      <div data-testid="offboarding-progress" style={{ marginBottom: '24px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
          ...
          <span data-testid="progress-percentage" style={{ fontSize: '13px', fontWeight: 600, color: '#111827' }}>
            {progress}%
          </span>
        </div>
      ...
      <div data-testid="offboarding-steps" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      {allDone && (
        <div style={{ marginTop: '24px', textAlign: 'center' }}>
          <Button
            data-testid="finish-offboarding-btn"
            variant="primary"
            onClick={onFinish}
          >
            Finish Offboarding
