...
describe('PersonnelOffboardingFlow', () => {
  ...
  it('renders offboarding flow container', async () => {
    const { getByTestId } = await render(
      <PersonnelOffboardingFlow person={mockPersonnel} completedSteps={[]} onComplete={() => {}} onFinish={() => {}} />
    )
  ...
  for (const step of ALL_STEPS) {
    ...
    it(`step ${step} is marked complete when in completedSteps`, async () => {
      const { getByTestId } = await render(
        <PersonnelOffboardingFlow person={mockPersonnel} completedSteps={[step]} onComplete={() => {}} onFinish={() => {}} />
      )
    ...
    it(`calls onComplete with ${step} when button clicked`, async () => {
      let completed = ''
      const { getByTestId } = await render(
        <PersonnelOffboardingFlow person={mockPersonnel} completedSteps={[]} onComplete={(s) => { completed = s }} onFinish={() => {}} />
      )
  ...
  it('shows 1 of 4 when one step completed', async () => {
    const { getByTestId } = await render(
      <PersonnelOffboardingFlow person={mockPersonnel} completedSteps={['revoke-access']} onComplete={() => {}} onFinish={() => {}} />
    )
  ...
  it('shows 2 of 4 when two steps completed', async () => {
    const { getByTestId } = await render(
      <PersonnelOffboardingFlow person={mockPersonnel} completedSteps={['revoke-access', 'exit-interview']} onComplete={() => {}} onFinish={() => {}} />
    )
  ...
  it('shows 4 of 4 when all steps completed', async () => {
    const { getByTestId } = await render(
      <PersonnelOffboardingFlow person={mockPersonnel} completedSteps={ALL_STEPS} onComplete={() => {}} onFinish={() => {}} />
    )
  ...
  it('progress is 75% when 3 steps done', async () => {
    const { getByTestId } = await render(
      <PersonnelOffboardingFlow person={mockPersonnel} completedSteps={['revoke-access', 'exit-interview', 'return-equipment']} onComplete={() => {}} onFinish={() => {}} />
    )
  ...
  it('calls onFinish when finish button clicked', async () => {
    let finished = false
    const { getByTestId } = await render(
      <PersonnelOffboardingFlow person={mockPersonnel} completedSteps={ALL_STEPS} onComplete={() => {}} onFinish={() => { finished = true }} />
    )
  ...
  it('snapshot: half steps completed', async () => {
    const { container } = await render(
      <PersonnelOffboardingFlow person={mockPersonnel} completedSteps={['revoke-access', 'return-equipment']} onComplete={() => {}} onFinish={() => {}} />
    )
