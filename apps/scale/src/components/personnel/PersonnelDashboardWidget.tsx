  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div data-testid="stat-total-count" style={{ fontSize: '28px', fontWeight: 700, color: '#111827' }}>
            {total}
          </div>
          <div style={{ fontSize: '12px', color: '#6b7280', marginTop: '4px' }}>Total Headcount</div>
        </div>
        ...
        >
          ...
          <div style={{ fontSize: '12px', color: '#6b7280', marginTop: '4px' }}>Pending BG Check</div>
        </div>
      </div>
