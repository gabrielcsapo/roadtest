    ...
    <div data-testid="audit-timeline-container" data-item-count={limitedLogs.length}>
      {dateKeys.map((dateKey) => (
        <div key={dateKey} data-testid={`timeline-date-group-${dateKey.replace(/\s/g, "-")}`}>
          ...
          <div
            data-testid="timeline-group-items"
            ...
            {grouped[dateKey].map((log) => (
              ...
              >
                ...
                >
                  ...
                  />
                  <span
                    data-testid={`timeline-actor-${log.id}`}
                  ...
                  <span
                    data-testid={`timeline-time-${log.id}`}
                    style={{ fontSize: "0.75rem", color: "#9ca3af", marginLeft: "auto" }}
                  >
                ...
                <div style={{ paddingLeft: "24px" }}>
                  <span
                    data-testid={`timeline-target-${log.id}`}
      ...
      {maxItems !== undefined && logs.length > maxItems && (
        <div
          ...
          style={{ textAlign: "center", padding: "8px", fontSize: "0.875rem", color: "#6b7280" }}
        >
