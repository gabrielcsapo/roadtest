    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexWrap: 'wrap' }}>
          <span data-testid="actor-name" style={{ fontWeight: 500, fontSize: compact ? '0.75rem' : '0.875rem' }}>
            {log.actor.name}
          </span>
          <AuditActionBadge data-testid="action-badge" action={log.action} size={compact ? 'sm' : 'md'} />
        </div>
        {!compact && (
          <div
