...
export function VendorDetails({ vendor, loading = false, onEdit, onArchive }: VendorDetailsProps) {
  ...
  if (loading) {
    return (
      <div
        data-testid="vendor-details-loading"
  ...
  return (
    <div data-testid="vendor-details">
      <div
        data-testid="vendor-details-header"
        style={{
          display: "flex",
      ...
      >
        <div>
          ...
          <div
            data-testid="vendor-details-badges"
        ...
        <div data-testid="vendor-details-actions" style={{ display: "flex", gap: "8px" }}>
          ...
          {onArchive && (
            <Button
              data-testid="details-archive-button"
              variant="secondary"
        ...
        {activeTab === "Overview" && (
          <Card data-testid="tab-overview">
            ...
            {vendor.tags && vendor.tags.length > 0 && (
              <div
                data-testid="overview-tags"
                style={{ marginTop: "12px", display: "flex", gap: "6px", flexWrap: "wrap" }}
              >
                {vendor.tags.map((tag) => (
                  <Badge key={tag} data-testid={`overview-tag-${tag}`}>
                    {tag}
                  </Badge>
                ))}
              </div>
