...
describe("VendorStatusFilter", () => {
  ...
  it("renders filter container", async () => {
    const { getByTestId } = await render(
      <VendorStatusFilter value={emptyFilters} onChange={() => {}} />,
    );
  ...
  it("shows clear all button when status filter active", async () => {
    const { getByTestId } = await render(
      <VendorStatusFilter value={{ status: ["active"], risk: [] }} onChange={() => {}} />,
    );
  ...
  it("shows clear all button when risk filter active", async () => {
    const { getByTestId } = await render(
      <VendorStatusFilter value={{ status: [], risk: ["high"] }} onChange={() => {}} />,
    );
    expect(getByTestId("clear-filters")).toBeDefined();
  });
  ...
  it("clear all removes all status filters", async () => {
    ...
    const { getByTestId } = await render(
      <VendorStatusFilter
        value={{ status: ["active", "inactive"], risk: [] }}
        onChange={(f) => {
          newFilters = f;
        }}
      />,
  ...
  it("snapshot with active filters", async () => {
    await render(
      <VendorStatusFilter value={{ status: ["active"], risk: ["critical"] }} onChange={() => {}} />,
    );
  ...
  it("snapshot with all filters", async () => {
    await render(
      <VendorStatusFilter
        value={{ status: [...statuses], risk: [...riskLevels] }}
        onChange={() => {}}
      />,
    );
  ...
  it("renders correctly with empty vendorCounts", async () => {
    const { getByTestId } = await render(
      <VendorStatusFilter value={emptyFilters} onChange={() => {}} vendorCounts={{}} />,
    );
    expect(getByTestId("vendor-status-filter")).toBeDefined();
  });
  ...
  it("renders with undefined status in value", async () => {
    const { getByTestId } = await render(
      <VendorStatusFilter value={{ search: "test" }} onChange={() => {}} />,
    );
    expect(getByTestId("vendor-status-filter")).toBeDefined();
  });
  ...
  it("renders with undefined risk in value", async () => {
    const { getByTestId } = await render(
      <VendorStatusFilter value={{ status: ["active"] }} onChange={() => {}} />,
    );
    expect(getByTestId("vendor-status-filter")).toBeDefined();
  });
  ...
  it("preserves existing filter values when adding new ones", async () => {
    ...
    const { getByTestId } = await render(
      <VendorStatusFilter
        value={{ status: ["active"], risk: ["low"], search: "test" }}
        onChange={(f) => {
          newFilters = f;
        }}
      />,
  ...
  it("snapshot with only critical risk selected", async () => {
    await render(
      <VendorStatusFilter value={{ status: [], risk: ["critical"] }} onChange={() => {}} />,
    );
  ...
  it("clear button click triggers onChange with empty arrays", async () => {
    ...
    const { getByTestId } = await render(
      <VendorStatusFilter
        value={{ status: ["active"], risk: ["critical"] }}
        onChange={(f) => {
          newFilters = f;
        }}
      />,
  ...
  it("vendor-status-filter data-testid is vendor-status-filter", async () => {
    ...
    expect(getByTestId("vendor-status-filter").getAttribute("data-testid")).toBe(
  ...
  it("status-filter-label data-testid is status-filter-label", async () => {
    ...
    expect(getByTestId("status-filter-label").getAttribute("data-testid")).toBe(
      "status-filter-label",
    );
  });
  ...
  it("status-checkbox-active data-testid is status-checkbox-active", async () => {
    ...
    expect(getByTestId("status-checkbox-active").getAttribute("data-testid")).toBe(
  ...
  it("risk-checkbox-high data-testid is risk-checkbox-high", async () => {
    ...
    expect(getByTestId("risk-checkbox-high").getAttribute("data-testid")).toBe(
      "risk-checkbox-high",
    );
  });
  ...
  it("low risk checkbox is checked when low in filter", async () => {
    const { getByTestId } = await render(
      <VendorStatusFilter value={{ status: [], risk: ["low"] }} onChange={() => {}} />,
    );
  ...
  it("pending checkbox is checked when pending in filter", async () => {
    const { getByTestId } = await render(
      <VendorStatusFilter value={{ status: ["pending"], risk: [] }} onChange={() => {}} />,
    );
  ...
  it("snapshot with vendor counts", async () => {
    await render(
      <VendorStatusFilter
        value={emptyFilters}
        onChange={() => {}}
        vendorCounts={{ active: 10, inactive: 5, high: 3, critical: 2 }}
      />,
    );
