...
describe("VendorDeleteConfirm", () => {
  ...
  it("renders modal when open=true", async () => {
    const { getByTestId } = await render(
      <VendorDeleteConfirm vendor={mockVendor} open onConfirm={() => {}} onCancel={() => {}} />,
    );
  ...
  for (const vendor of vendors) {
    it(`shows correct vendor name for: ${vendor.name}`, async () => {
      const { getByTestId } = await render(
        <VendorDeleteConfirm vendor={vendor} open onConfirm={() => {}} onCancel={() => {}} />,
      );
  ...
  it("renders with vendor that has long name", async () => {
    const { getByTestId } = await render(
      <VendorDeleteConfirm
        vendor={{ ...mockVendor, name: "A Very Long Vendor Name Here" }}
        open
        onConfirm={() => {}}
        onCancel={() => {}}
      />,
  ...
  it("snapshot with different vendor", async () => {
    await render(
      <VendorDeleteConfirm
        vendor={{ ...mockVendor, name: "Globex Inc", riskLevel: "critical" }}
        open
        onConfirm={() => {}}
        onCancel={() => {}}
      />,
  ...
  it("snapshot for Acme Corp open", async () => {
    await render(
      <VendorDeleteConfirm vendor={vendors[0]} open onConfirm={() => {}} onCancel={() => {}} />,
    );
  ...
  it("snapshot for Globex Inc open", async () => {
    await render(
      <VendorDeleteConfirm vendor={vendors[1]} open onConfirm={() => {}} onCancel={() => {}} />,
    );
  ...
  it("snapshot for Umbrella Corp open", async () => {
    await render(
      <VendorDeleteConfirm vendor={vendors[2]} open onConfirm={() => {}} onCancel={() => {}} />,
    );
  ...
  it("snapshot for Initech open", async () => {
    await render(
      <VendorDeleteConfirm vendor={vendors[3]} open onConfirm={() => {}} onCancel={() => {}} />,
    );
  ...
  it("snapshot for Massive Dynamic open", async () => {
    await render(
      <VendorDeleteConfirm vendor={vendors[4]} open onConfirm={() => {}} onCancel={() => {}} />,
    );
  ...
  it("message contains vendor name from prop", async () => {
    const { getByTestId } = await render(
      <VendorDeleteConfirm
        vendor={{ ...mockVendor, name: "Test Vendor X" }}
        open
        onConfirm={() => {}}
        onCancel={() => {}}
      />,
  ...
  it("vendor-delete-modal data-testid is vendor-delete-modal", async () => {
    ...
    expect(getByTestId("vendor-delete-modal").getAttribute("data-testid")).toBe(
      "vendor-delete-modal",
    );
  });
  ...
  it("delete-confirm-container data-testid is delete-confirm-container", async () => {
    ...
    expect(getByTestId("delete-confirm-container").getAttribute("data-testid")).toBe(
  ...
  it("delete-confirm-title data-testid is delete-confirm-title", async () => {
    ...
    expect(getByTestId("delete-confirm-title").getAttribute("data-testid")).toBe(
  ...
  it("confirm-delete-button data-testid is confirm-delete-button", async () => {
    ...
    expect(getByTestId("confirm-delete-button").getAttribute("data-testid")).toBe(
  ...
  it("cancel-delete-button data-testid is cancel-delete-button", async () => {
    ...
    expect(getByTestId("cancel-delete-button").getAttribute("data-testid")).toBe(
  ...
  it("delete-vendor-name data-testid is delete-vendor-name", async () => {
    ...
    expect(getByTestId("delete-vendor-name").getAttribute("data-testid")).toBe(
      "delete-vendor-name",
    );
  });
  ...
  it("delete-vendor-risk data-testid is delete-vendor-risk", async () => {
    ...
    expect(getByTestId("delete-vendor-risk").getAttribute("data-testid")).toBe(
      "delete-vendor-risk",
    );
  });
  ...
  it("delete-vendor-status data-testid is delete-vendor-status", async () => {
    ...
    expect(getByTestId("delete-vendor-status").getAttribute("data-testid")).toBe(
  ...
  it("delete-vendor-category data-testid is delete-vendor-category", async () => {
    ...
    expect(getByTestId("delete-vendor-category").getAttribute("data-testid")).toBe(
  ...
  it("status archived shown in modal", async () => {
    const { getByTestId } = await render(
      <VendorDeleteConfirm
        vendor={{ ...mockVendor, status: "archived" }}
        open
        onConfirm={() => {}}
        onCancel={() => {}}
      />,
