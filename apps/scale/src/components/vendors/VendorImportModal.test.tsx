...
describe('VendorImportModal', () => {
  ...
  it('renders modal when open=true', async () => {
    const { getByTestId } = await render(<VendorImportModal open onClose={() => {}} onImport={() => {}} />)
  ...
  it('hides preview step initially', async () => {
    const { queryByTestId } = await render(<VendorImportModal open onClose={() => {}} onImport={() => {}} />)
    expect(queryByTestId('import-preview-step')).toBeNull()
  })

  // Closed state (5)
  it('renders null when open=false', async () => {
    const { queryByTestId } = await render(<VendorImportModal open={false} onClose={() => {}} onImport={() => {}} />)
  ...
  it('calls onClose when cancel button clicked', async () => {
    let closed = false
    const { getByTestId } = await render(<VendorImportModal open onClose={() => { closed = true }} onImport={() => {}} />)
  ...
  it('cancel button disabled when loading', async () => {
    const { getByTestId } = await render(<VendorImportModal open onClose={() => {}} onImport={() => {}} loading />)
    expect(getByTestId('cancel-import-button').disabled).toBeTruthy()
  })

  it('fires onClose multiple times', async () => {
    let count = 0
    const { getByTestId } = await render(<VendorImportModal open onClose={() => { count++ }} onImport={() => {}} />)
    await fireEvent.click(getByTestId('cancel-import-button'))
    expect(count).toBe(1)
  })
  ...
  it('does not call onImport when cancel clicked', async () => {
    let imported = false
    const { getByTestId } = await render(<VendorImportModal open onClose={() => {}} onImport={() => { imported = true }} />)
    await fireEvent.click(getByTestId('cancel-import-button'))
  ...
  it('renders correctly when open toggles from false to true', async () => {
    const { getByTestId } = await render(<VendorImportModal open={true} onClose={() => {}} onImport={() => {}} />)
  ...
  it('does not render modal when open is false regardless of loading', async () => {
    const { queryByTestId } = await render(<VendorImportModal open={false} onClose={() => {}} onImport={() => {}} loading />)
    expect(queryByTestId('vendor-import-modal')).toBeNull()
  })
  ...
  it('does not call onImport initially', async () => {
    let imported = false
    await render(<VendorImportModal open onClose={() => {}} onImport={() => { imported = true }} />)
    expect(imported).toBe(false)
  })
  ...
  it('modal data-testid is vendor-import-modal', async () => {
    const { getByTestId } = await render(<VendorImportModal open onClose={() => {}} onImport={() => {}} />)
    expect(getByTestId('vendor-import-modal').getAttribute('data-testid')).toBe('vendor-import-modal')
  })
  ...
  it('import-instructions data-testid is import-instructions', async () => {
    const { getByTestId } = await render(<VendorImportModal open onClose={() => {}} onImport={() => {}} />)
    expect(getByTestId('import-instructions').getAttribute('data-testid')).toBe('import-instructions')
  })
  ...
  it('cancel-import-button data-testid is cancel-import-button', async () => {
    const { getByTestId } = await render(<VendorImportModal open onClose={() => {}} onImport={() => {}} />)
    expect(getByTestId('cancel-import-button').getAttribute('data-testid')).toBe('cancel-import-button')
  })
  ...
  it('file-input-wrapper data-testid is file-input-wrapper', async () => {
    const { getByTestId } = await render(<VendorImportModal open onClose={() => {}} onImport={() => {}} />)
    expect(getByTestId('file-input-wrapper').getAttribute('data-testid')).toBe('file-input-wrapper')
  })
  ...
  it('upload step hidden when loading', async () => {
    const { queryByTestId } = await render(<VendorImportModal open onClose={() => {}} onImport={() => {}} loading />)
  ...
  it('does not call onImport without file selection', async () => {
    let called = false
    await render(<VendorImportModal open onClose={() => {}} onImport={() => { called = true }} />)
    expect(called).toBe(false)
  })

  it('does not call onClose without interaction', async () => {
    let called = false
    await render(<VendorImportModal open onClose={() => { called = true }} onImport={() => {}} />)
    expect(called).toBe(false)
  })
