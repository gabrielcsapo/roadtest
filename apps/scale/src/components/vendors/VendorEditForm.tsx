...
const CATEGORY_OPTIONS = ['Cloud Infrastructure', 'Payment Processing', 'HR Software', 'Security', 'Analytics', 'Communication', 'Other']

export function VendorEditForm({ vendor, onSubmit, onCancel, loading = false }: VendorEditFormProps) {
    ...
    <form data-testid="vendor-edit-form" onSubmit={handleSubmit} noValidate>
      ...
      <div data-testid="field-website" style={{ marginBottom: '16px' }}>
        ...
        <Input
          ...
          disabled={loading}
        />
        {errors.website && <span data-testid="error-website" style={{ color: 'red', fontSize: '12px' }}>{errors.website}</span>}
      </div>
      ...
      <div data-testid="field-contact-email" style={{ marginBottom: '16px' }}>
        ...
        <Input
          ...
          disabled={loading}
        />
        {errors.contactEmail && <span data-testid="error-contact-email" style={{ color: 'red', fontSize: '12px' }}>{errors.contactEmail}</span>}
      </div>
      ...
      <div data-testid="field-category" style={{ marginBottom: '16px' }}>
        ...
        {errors.category && <span data-testid="error-category" style={{ color: 'red', fontSize: '12px' }}>{errors.category}</span>}
      </div>
      ...
      <div data-testid="form-actions" style={{ display: 'flex', gap: '12px' }}>
        ...
        <Button data-testid="cancel-button" type="button" variant="secondary" onClick={onCancel} disabled={loading}>
          Cancel
        </Button>
      </div>
    </form>
