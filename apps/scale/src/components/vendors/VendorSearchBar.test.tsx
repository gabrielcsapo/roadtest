...
describe('VendorSearchBar', () => {
  ...
  it('renders search bar container', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={10} />
    )
  ...
  it('snapshot default state', async () => {
    await render(<VendorSearchBar search="" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={10} />)
    await snapshot('vendor-search-bar-default')
  })

  it('snapshot with search', async () => {
    await render(<VendorSearchBar search="acme" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={2} />)
    await snapshot('vendor-search-bar-with-search')
  })

  it('snapshot with filters', async () => {
    await render(<VendorSearchBar search="" onSearchChange={() => {}} filters={{ status: ['active'], risk: ['high'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={5} />)
    await snapshot('vendor-search-bar-with-filters')
  })

  it('search input has correct value', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="acme" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={3} />
    )
  ...
  it('shows total count when not filtered', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={25} filteredCount={25} />
    )
  ...
  it('shows vendor singular when totalCount is 1', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={1} filteredCount={1} />
    )
  ...
  it('shows vendors plural when totalCount is more than 1', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={5} filteredCount={5} />
    )
  ...
  it('shows filtered count when search active', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="test" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={20} filteredCount={3} />
    )
  ...
  it('shows X of Y format when filtering', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="acme" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={50} filteredCount={4} />
    )
  ...
  it('shows 0 of total when no results', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="zzz" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={0} />
    )
  ...
  it('shows filtered count when filters active', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ status: ['active'] }} onFiltersChange={() => {}} totalCount={20} filteredCount={12} />
    )
  ...
  it('shows 0 vendors when totalCount is 0', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={0} filteredCount={0} />
    )
  ...
  it('shows 100 vendors correctly', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={100} filteredCount={100} />
    )
  ...
  it('shows 1000 vendors correctly', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={1000} filteredCount={1000} />
    )
  ...
  it('calls onSearchChange when input changes', async () => {
    let changed = false
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => { changed = true }} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={10} />
    )
  ...
  it('calls onSearchChange with input value', async () => {
    let value = ''
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={v => { value = v }} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={10} />
    )
    await fireEvent.change(getByTestId('search-input'), { target: { value: 'acme' } })
  ...
  it('calls onSearchChange with empty string when clear search clicked', async () => {
    let value = 'unchanged'
    const { getByTestId } = await render(
      <VendorSearchBar search="acme" onSearchChange={v => { value = v }} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={3} />
    )
  ...
  it('clears search when clear all clicked', async () => {
    ...
    const { getByTestId } = await render(
      <VendorSearchBar search="acme" onSearchChange={v => { searchVal = v }} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={3} />
    )
  ...
  it('clears filters when clear all clicked', async () => {
    ...
    const { getByTestId } = await render(
      <VendorSearchBar search="acme" onSearchChange={() => {}} filters={{ status: ['active'] }} onFiltersChange={f => { newFilters = f }} totalCount={10} filteredCount={3} />
    )
    await fireEvent.click(getByTestId('clear-all-button'))
  ...
  it('shows active filter count badge', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ status: ['active', 'pending'], risk: ['high'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={5} />
    )
  ...
  it('shows filter count as 1 filter singular', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ status: ['active'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={5} />
    )
  ...
  it('shows filter count as plural for 2', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ status: ['active', 'pending'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={5} />
    )
  ...
  it('counts tag filters too', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ tags: ['cloud', 'saas', 'security'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={5} />
    )
    expect(getByTestId('active-filter-count').textContent).toContain('3')
  })
  ...
  it('handles very long search string', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search={"a".repeat(100)} onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={0} />
    )
    expect(getByTestId('vendor-search-bar')).toBeDefined()
  })
  ...
  it('shows clear all when filters have risk active', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ risk: ['critical'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={2} />
    )
    expect(getByTestId('clear-all-button')).toBeDefined()
  })
  ...
  it('snapshot with all active', async () => {
    await render(
      <VendorSearchBar search="acme" onSearchChange={() => {}} filters={{ status: ['active'], risk: ['high'] }} onFiltersChange={() => {}} totalCount={20} filteredCount={3} />
    )
  ...
  it('shows correct count after filters', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ status: ['active'] }} onFiltersChange={() => {}} totalCount={50} filteredCount={30} />
    )
  ...
  it('renders without active filters badge by default', async () => {
    const { queryByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ status: [], risk: [], tags: [] }} onFiltersChange={() => {}} totalCount={10} filteredCount={10} />
    )
    expect(queryByTestId('active-filter-count')).toBeNull()
  })
  ...
  it('renders when filteredCount equals totalCount', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={15} filteredCount={15} />
    )
  ...
  it('renders when filteredCount is zero', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="xyz" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={15} filteredCount={0} />
    )
  ...
  it('renders correctly with tag filters', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ tags: ['cloud'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={5} />
    )
    expect(getByTestId('active-filter-count')).toBeDefined()
  })
  ...
  it('clear all calls both handlers', async () => {
    ...
    const { getByTestId } = await render(
      <VendorSearchBar
        search="acme"
        onSearchChange={v => { if (v === '') searchCleared = true }}
        filters={{ status: ['active'] }}
        onFiltersChange={f => { if ((f.status?.length ?? 0) === 0) filtersCleared = true }}
        totalCount={10}
        filteredCount={3}
      />
    )
  ...
  it('renders with large filteredCount', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="test" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={5000} filteredCount={2500} />
    )
  ...
  it('fires onSearchChange on every keystroke simulation', async () => {
    let count = 0
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => { count++ }} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={10} />
    )
  ...
  it('renders correctly with undefined filter fields', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{}} onFiltersChange={() => {}} totalCount={10} filteredCount={10} />
    )
    expect(getByTestId('vendor-search-bar')).toBeDefined()
  })
  ...
  it('clear-search-button data-testid is clear-search-button', async () => {
    ...
    expect(getByTestId('clear-search-button').getAttribute('data-testid')).toBe('clear-search-button')
  })
  ...
  it('active-filter-count data-testid is active-filter-count', async () => {
    ...
    expect(getByTestId('active-filter-count').getAttribute('data-testid')).toBe('active-filter-count')
  })

  it('result count shows 3 vendors when totalCount=3 and filteredCount=3', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={3} filteredCount={3} />
    )
  ...
  it('result count shows 7 of 20 when filtered', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="test" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={20} filteredCount={7} />
    )
  ...
  it('result count shows 15 of 100 when filtered', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="test" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={100} filteredCount={15} />
    )
  ...
  it('1 filter shows singular label', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ risk: ['high'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={3} />
    )
    expect(getByTestId('active-filter-count').textContent).toContain('1 filter')
  })
  ...
  it('4 filters shows plural label', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ status: ['active', 'pending'], risk: ['high', 'critical'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={3} />
    )
  ...
  it('fires onSearchChange with value "test"', async () => {
    let val = ''
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={v => { val = v }} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={10} />
    )
  ...
  it('fires onSearchChange with value empty string when cleared', async () => {
    let val = 'old'
    const { getByTestId } = await render(
      <VendorSearchBar search="acme" onSearchChange={v => { val = v }} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={3} />
    )
    await fireEvent.click(getByTestId('clear-search-button'))
    expect(val).toBe('')
  })
  ...
  it('renders with search "umbrella" and reflects input value', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="umbrella" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={1} />
    )
  ...
  it('renders with search "initech" and reflects input value', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="initech" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={1} />
    )
  ...
  it('renders with search "massive" and shows clear button', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="massive" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={1} />
    )
    expect(getByTestId('clear-search-button')).toBeDefined()
  })
  ...
  it('shows clear all button when risk filter active', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ risk: ['medium'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={4} />
    )
    expect(getByTestId('clear-all-button')).toBeDefined()
  })
  ...
  it('shows clear all button when tag filter active', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ tags: ['cloud'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={4} />
    )
    expect(getByTestId('clear-all-button')).toBeDefined()
  })
  ...
  it('shows clear all button when status filter active', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ status: ['inactive'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={2} />
    )
    expect(getByTestId('clear-all-button')).toBeDefined()
  })
  ...
  it('fires onFiltersChange when clear all is clicked', async () => {
    let fired = false
    const { getByTestId } = await render(
      <VendorSearchBar search="acme" onSearchChange={() => {}} filters={{ status: ['active'] }} onFiltersChange={() => { fired = true }} totalCount={10} filteredCount={3} />
    )
    await fireEvent.click(getByTestId('clear-all-button'))
  ...
  it('onFiltersChange receives empty filters when clear all clicked', async () => {
    ...
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ status: ['active'] }} onFiltersChange={f => { received = f }} totalCount={10} filteredCount={5} />
    )
    await fireEvent.click(getByTestId('clear-all-button'))
  ...
  it('filters with 3 risk show count 3', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ risk: ['low', 'medium', 'high'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={5} />
    )
    expect(getByTestId('active-filter-count').textContent).toContain('3')
  })
  ...
  it('result count shows "2 vendors" plural', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={2} filteredCount={2} />
    )
  ...
  it('result count shows "50 vendors" for 50', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={50} filteredCount={50} />
    )
  ...
  it('shows result-count text for filtered=5 total=25', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="test" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={25} filteredCount={5} />
    )
  ...
  it('shows result-count text for filtered=0 total=5', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="xyz" onSearchChange={() => {}} filters={emptyFilters} onFiltersChange={() => {}} totalCount={5} filteredCount={0} />
    )
  ...
  it('shows correct filter count for 2 tags', async () => {
    const { getByTestId } = await render(
      <VendorSearchBar search="" onSearchChange={() => {}} filters={{ tags: ['cloud', 'saas'] }} onFiltersChange={() => {}} totalCount={10} filteredCount={5} />
    )
    expect(getByTestId('active-filter-count').textContent).toContain('2')
  })
  ...
  it('clear search calls onSearchChange with empty on second clear', async () => {
    let val = ''
    const { getByTestId } = await render(
      <VendorSearchBar search="something" onSearchChange={v => { val = v }} filters={emptyFilters} onFiltersChange={() => {}} totalCount={10} filteredCount={1} />
    )
    await fireEvent.click(getByTestId('clear-search-button'))
    expect(val).toBe('')
  })
