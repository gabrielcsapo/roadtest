...
export function VendorContactCard({
  ...
  return (
    <Card data-testid="vendor-contact-card">
      ...
      >
        <div>
          <div data-testid="contact-name" style={{ fontWeight: 600, fontSize: "16px" }}>
            {name}
          </div>
          {role && (
            <Badge data-testid="contact-role" style={{ marginTop: "4px" }}>
              {role}
            </Badge>
          )}
        </div>
      ...
      >
        ...
        >
          <span data-testid="contact-email-label" style={{ color: "#6b7280", fontSize: "13px" }}>
            Email:
          </span>
        ...
        {phone && (
          <div
            ...
            style={{ display: "flex", alignItems: "center", gap: "8px" }}
          >
            <span data-testid="contact-phone-label" style={{ color: "#6b7280", fontSize: "13px" }}>
              Phone:
            </span>
