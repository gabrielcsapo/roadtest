...
export function PolicyComplianceSummary({ policies, onFilterByStatus, loading }: PolicyComplianceSummaryProps) {
  if (loading) {
    return (
      <div data-testid="compliance-summary-loading" style={{ display: 'flex', justifyContent: 'center', padding: '40px' }}>
  ...
  return (
    <div data-testid="compliance-summary-container">
      <h3 data-testid="compliance-summary-title" style={{ marginBottom: '16px', fontSize: '1rem', fontWeight: 600 }}>
        Compliance Summary
      </h3>
      <div
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div>
                  ...
                  <div
                    ...
                    style={{ fontSize: '1.5rem', fontWeight: 700, color: config.color, marginTop: '4px' }}
                  >
                    {count}
                  </div>
                </div>
      ...
      <div data-testid="compliance-summary-total" style={{ marginTop: '12px', fontSize: '0.875rem', color: '#6b7280' }}>
