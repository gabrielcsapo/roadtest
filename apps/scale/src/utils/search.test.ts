...
describe('matchesSearch - multi-token search', () => {
  const mtCases = [
    { item: { name: 'Acme Corp', desc: 'A cloud company' }, fields: ['name', 'desc'], q: 'Acme cloud', expected: true },
    { item: { name: 'Acme Corp', desc: 'A cloud company' }, fields: ['name', 'desc'], q: 'Acme AWS', expected: false },
    { item: { name: 'Beta LLC', desc: 'SaaS provider' }, fields: ['name', 'desc'], q: 'Beta SaaS', expected: true },
    { item: { name: 'Gamma Inc', desc: 'On-premise' }, fields: ['name', 'desc'], q: 'Gamma cloud', expected: false },
