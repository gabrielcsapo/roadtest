...
describe('riskToScore - score ordering', () => {
  ...
  it('riskToScore low is 25', () => { expect(riskToScore('low')).toBe(25) })
  it('riskToScore medium is 50', () => { expect(riskToScore('medium')).toBe(50) })
  it('riskToScore high is 75', () => { expect(riskToScore('high')).toBe(75) })
  it('riskToScore critical is 100', () => { expect(riskToScore('critical')).toBe(100) })
