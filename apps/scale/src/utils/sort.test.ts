...
describe('sort', () => {
  describe('sortByField - string fields', () => {
    ...
    it('handles equal values', () => {
      const arr = [{ name: 'Alice', score: 10 }, { name: 'Bob', score: 10 }]
    ...
    it('handles undefined values by putting them last', () => {
      const arr = [{ name: 'B', extra: undefined }, { name: 'A', extra: 'defined' }]
    ...
    const stringSortCases = [
      { arr: ['cherry', 'apple', 'banana', 'date', 'elderberry'], expected: ['apple', 'banana', 'cherry', 'date', 'elderberry'] },
  ...
  describe('sortByDate', () => {
    ...
    it('handles single element', () => {
      expect(sortByDate([{ name: 'A', date: '2024-01-01T00:00:00Z' }], 'date', 'asc')).toHaveLength(1)
    })
    ...
    for (const c of dateCases) {
      it(`sorts ${c.a} and ${c.b} correctly ascending`, () => {
        const arr = [{ name: 'a', date: c.a }, { name: 'b', date: c.b }]
  ...
  describe('sortByField - additional edge cases', () => {
    ...
    const stringSortAdditional = [
      ...
      { arr: [{ s: 'beta' }, { s: 'alpha' }, { s: 'gamma' }], dir: 'asc' as const, firstExpected: 'alpha' },
      { arr: [{ s: 'beta' }, { s: 'alpha' }, { s: 'gamma' }], dir: 'desc' as const, firstExpected: 'gamma' },
      { arr: [{ s: 'one' }, { s: 'two' }, { s: 'three' }], dir: 'asc' as const, firstExpected: 'one' },
    ]
  ...
  describe('sortByMultiple - additional', () => {
    ...
    it('handles all same values stably', () => {
      const arr = [{ v: 5, id: 1 }, { v: 5, id: 2 }, { v: 5, id: 3 }]
      const result = sortByMultiple(arr, [{ field: 'v', dir: 'asc' }])
...
describe('sortByField - string alphabetical tests', () => {
  const alphabetCases = [
    ...
    { arr: [{ s: 'charlie' }, { s: 'alice' }, { s: 'bob' }], expected: ['alice', 'bob', 'charlie'] },
    { arr: [{ s: 'delta' }, { s: 'alpha' }, { s: 'beta' }, { s: 'gamma' }], expected: ['alpha', 'beta', 'delta', 'gamma'] },
    { arr: [{ s: 'one' }, { s: 'two' }, { s: 'three' }, { s: 'four' }, { s: 'five' }], expected: ['five', 'four', 'one', 'three', 'two'] },
  ]
